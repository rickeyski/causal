...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_serviceitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('location_long', self.gf('django.db.models.fields.FloatField')()),
            ('location_lat', self.gf('django.db.models.fields.FloatField')()),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.UserService'])),
            ('link_back', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('main', ['ServiceItem'])


    def backwards(self, orm):
        
        # Deleting model 'ServiceItem'
        db.delete_table('main_serviceitem')
